...
if [[ -n $RUN_ARG ]]; then echo "export alias autostake='cd /restake; npm run autostake $RUN_ARG'" >> ~/.bashrc; else echo "export alias autostake='cd /restake; npm run autostake'" >> ~/.bashrc; fi
source ~/.bashrc
autostake
