...
if [[ -n $RUN_ARG ]]; then echo "alias autostake='cd /restake; npm run autostake $RUN_ARG'" >  ~/.envst; source ~/.envst; else echo "alias autostake='cd /restake; npm run autostake'" >  ~/.envst; source ~/.envst; fi
autostake
